...
public class OAuth2AccessTokenRequestProviderImpl implements OAuth2AccessTokenRequestProvider {
    ...
    public String getAccessToken(final Registration registration, final String code) {
        ...
        map.put(OAuth2Parameter.GRANT_TYPE.getPath(), OAuth2Parameter.GRANT_TYPE.getDefaultValue());
